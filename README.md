...
L'application implémente les opérations **CRUD (Create, Read, Update, Delete)** et utilise une architecture basée sur **Controller, Service et Repository** pour séparer les responsabilités.
...
```
git clone https://github.com/amine445d/gestion_contacts.git
```
